                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                            radius: 50,
                            backgroundImage: AssetImage('assets/profile.jpg'), // Changed from profile_picture.jpg
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          ProfileOptionCard(
                            icon: Icons.shopping_cart_outlined, // Changed from settings
                            title: 'My Cart',
                            onTap: () {
                              // Navigate to cart tab
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => BottomNavPage(initialIndex: 2), // Assuming cart is tab index 2
                                ),
                              );
                            },
                          ),
